...
import streamlit.components.import html
import json
import re
import time
import xml.etree.ElementTree as ET
...
# ============================================================
# SPACE UPDATE v0.8.7 · NORDIC CONTRAST · FOCUSED EUROPE + COUNTERSPACE VISUAL
...
def render_dashboard():
    ...
    raw_html(
        ...
        '<span>v0.8.7 Nordic Contrast · 16:9 · 24–40&quot; · refresh 15 min</span>'
        '</div>'
    )
